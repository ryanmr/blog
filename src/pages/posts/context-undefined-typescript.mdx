...
The [react docs were somewhat sparse on context](https://reactjs.org/docs/context.html). The [beta does offers slightly more context](https://beta.reactjs.org/learn/passing-data-deeply-with-context), but there are some patterns with the broader ecosyste (TypeScript) still missing.
