...
description: "Docker image optimization at its finest"
...
That's where the new _Output File Tracing_ comes in. Specifically, Standalone Mode. This is an amazing optimization.
