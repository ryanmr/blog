...
I haev tested this with what I think is a generic Cloudflare configuration, and I tested it out with an old school EJS deployment, a more modern Next SSR deployment and a Vite Static HTML file deployment.