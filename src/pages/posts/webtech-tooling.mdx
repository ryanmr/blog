...
What's wrong with [`typescript`](https://www.npmjs.com/package/typescript) and `tsc`? Nothing, actually. For years I had tried to innovation in place by testing in production wacky contraptions like swc. Tools are great, but at the end of the day, choosing boring tools has the advantage of accumulated wisdom and expertise behind it.
...
I would be remiss to say it's unicorns and rainbows with React though.
