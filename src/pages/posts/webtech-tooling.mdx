...
Rolling your own [SSR with React today is not easy](https://www.bestbuy.com/?react). Sure, you can do it, but it will be so customized, unrepeatable and unknowable. This is a [Dunning Kruger](https://en.wikipedia.org/wiki/Dunning%E2%80%93Kruger_effect) decision. If you're asking if you _should_ build your own framework, the answer is no. If you're asking if you _should_ build your own framework because you have expereince with their deficiencies and have explored many available options, then perhaps.
